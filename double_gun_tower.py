...
class DoubleGunTower(GunTower):
    def __init__(self, x, y):
        ...
        tower = pygame.image.load(os.path.join("assets", "towerDefense_tile250.png"))
        tower1 = pygame.image.load(os.path.join("assets", "doubleshootingtower1.png"))
        tower2 = pygame.image.load(os.path.join("assets", "doubleshootingtower2.png"))
        tower3 = pygame.image.load(os.path.join("assets", "doubleshootingtower3.png"))
